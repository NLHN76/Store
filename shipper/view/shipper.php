...
<div class="container mt-4">
    ...
    <div id="newOrderBanner" class="alert alert-success fixed-top text-center d-none" style="z-index:9999;">📦 Có đơn hàng mới!</div>
                        ...
                        <div id="order<?= $row['id'] ?>" class="collapse p-3">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <p><b>🚚 Shipper:</b> <?= $row['shipper_id'] ? htmlspecialchars($row['shipper_name']) : 'Chưa nhận' ?></p>
                                </div>
                            </div>
                        </div>
                    </td>
